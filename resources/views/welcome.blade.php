...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="index.html"> <img src="assets\img\medjestic-logo-216x62.png" alt="logo"> </a>
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          <li> <a href="/consola">JDentist</a> </li>
        </ul>
      </li>
      <!-- /Dashboard -->
      <!-- Doctor -->
      <li class="menu-item">
        ...
        <ul id="doctor" class="collapse" aria-labelledby="doctor" data-parent="#side-nav-accordion">
          <li> <a href="/consola_agregar_doctor">Añadir doctor</a> </li>
          <li> <a href="/consola_doctor">Lista de doctores</a> </li>
        </ul>
      </li>
      <!-- Doctor -->
      <!-- Patient -->
      <li class="menu-item">
        ...
        <ul id="patient" class="collapse" aria-labelledby="patient" data-parent="#side-nav-accordion">
          <li> <a href="/consola_agregar_paciente">Añadir paciente</a> </li>
          <li> <a href="/consola_paciente">Lista de pacientes</a> </li>
         <li><a href="/consola_expediente">Expedientes Clinicos</a></li>
        </ul>
      </li>
      <!-- /Patient -->
      <!-- Department -->
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#department" aria-expanded="false" aria-controls="department">
          <span><i class="fas fa-sitemap"></i>Recepcionista</span>
        </a>
        <ul id="department" class="collapse" aria-labelledby="department" data-parent="#side-nav-accordion">
          <li> <a href="/consola_agregar_recepcionista">Añadir recepcionista</a> </li>
          <li> <a href="/consola_recepcionista">Lista de recepcionista</a> </li>
        </ul>
      </li>
      <!-- /Department -->
      <!-- Schedule -->
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#schedule" aria-expanded="false" aria-controls="schedule">
          <span><i class="fas fa-list-alt"></i>Socios</span>
        </a>
        <ul id="schedule" class="collapse" aria-labelledby="schedule" data-parent="#side-nav-accordion">
          <li> <a href="/consola_agregar_socios">Añadir socio</a> </li>
          <li> <a href="/consola_socios">Lista de socio</a> </li>
        </ul>
      </li>
      <!-- /Schedule -->
      <!-- Appointment -->
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#appointment" aria-expanded="false" aria-controls="appointment">
          <span><i class="far fa-check-square"></i>Clinicas</span>
        </a>
        <ul id="appointment" class="collapse" aria-labelledby="appointment" data-parent="#side-nav-accordion">
          <li> <a href="/consola_agregar_clinicas">Añadir Clínicas</a> </li>
          <li> <a href="/consola_clinicas">Lista de clínicas</a> </li>
        </ul>
      </li>
      <!-- /Appointment -->
      <!-- Payment -->
      ...
      <!--<li class="menu-item">
        ...
        <ul id="report" class="collapse" aria-labelledby="report" data-parent="#side-nav-accordion">
          ...
          <li> <a href="pages\report\total-report.html">Total Report</a> </li>
        </ul>
      </li>-->
      <!-- /Report -->
      <!-- Human Resource -->
      <!--<li class="menu-item">
        ...
        <ul id="human-resource" class="collapse" aria-labelledby="human-resource" data-parent="#side-nav-accordion">
          ...
          <li> <a href="pages\human-resource\nurse-list.html">Nurse List</a> </li>
      ...
      <!--<li class="menu-item">
        ...
        <ul id="notice" class="collapse" aria-labelledby="notice" data-parent="#side-nav-accordion">
          <li> <a href="pages\notice\add-notice.html">Add Notice</a> </li>
          <li> <a href="pages\notice\notice-list.html">Notice List</a> </li>
        </ul>
      </li>-->
      <!-- /Notice -->
      <!--<li class="menu-item">
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index.html"><img src="assets\img\medjestic-logo-84x41.png" alt="logo"> </a>
      </div>
