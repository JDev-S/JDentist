        ...
        <div class="ms-profile-cover">
            ...
            <div class="ms-profile-user-info">
             ...
             <div class="ms-profile-user-buttons">
                     <a href="#" class="btn btn-primary"> <i class="material-icons">person_add</i>Ver estudios</a>
                     <a href="#" class="btn btn-light"> <i class="material-icons">file_download</i>Historial de abonos</a>
                  </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="ms-panel">
                <div class="ms-panel-header ms-panel-custome">
                    <h6>Notas de evolución</h6>
                    <label class="d-block mt-3"><a href="#" class="btn-link" data-toggle="modal" data-target="#modal-12">Añadir nota de evolución</a></label>
                </div>
                <div class="ms-panel-body">
    ...
    <div class="modal-dialog modal-dialog-centered modal-min" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <h1>Ingresar nota de evolución</h1>
                ...
                <form method="post">
                    ...
                    <button type="submit" class="btn btn-primary shadow-none">Agregar nota</button>
